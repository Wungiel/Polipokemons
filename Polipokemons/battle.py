...
class Battle(object):
    ...
    def drawBattle(self,screen):
        ...
        screen.blit(self.font.render(str(self.leftPokemon.health),1,(0,0,0)), self.leftHealthRect)
        screen.blit(self.font.render(str(self.rightPokemon.health),1,(0,0,0)), self.rightHealthRect)
    ...
    def attackEnemy(self):
        self.rightPokemon.health -= self.leftPokemon.strenght
        self.leftPokemon.health -= self.rightPokemon.strenght
